...
\       ["[o]        goto Opponent side (visual mode)",   "normal vo"],
\       ["[HJKLWB+-] expand selection   (visual mode)",   "normal v"],
...
\       ["[sp<textobj>] Replace textobj by yanked text",  "normal spif"],
\       ["[ac], [ic]  A/Inner Comment",                   "normal ac"],
\       ["[af], [if]  A/Inner Function",                  "normal af"],
