...
\       [" [2/]          Project",                                                    "normal 2/"],
\       ["               Qfreplace",                                                  "Qfreplace"],
\       [" [;]  easy motion",                                                         "call confirm('Type [;] key to use!')"],
\       ["[s;] fuzzy motion",                                                         "call confirm('Type [s;] key to use!')"],
\       ["[s/] fuzzy search",                                                         "call confirm('Type [s/] key to use!')"],
...
\       ["[g;][g,] next/prev changelist",                                             "normal g;"],
